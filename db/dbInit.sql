...
INSERT INTO account (id, active, confirm, login, password, version, account_details_id, modification_date_time, creation_date_time) VALUES (-1, true, true, 'kstepniak', '$2y$12$WSEHsn4jxmPQAEAHUAPfMOTwRi52jbaBfA0QOoZHvPgkr2CoxQ5sS', 0, -1, now(), now());
...
INSERT INTO account_auth_info (last_ip_address, current_auth, last_success_auth, last_incorrect_auth, incorrect_auth_count, account_id) VALUES (null, null, null, null, 0, -1);
...
INSERT INTO account (id, active, confirm, login, password, version, account_details_id, modification_date_time, creation_date_time) VALUES (-2, true, true, 'azambrzycki', '$2y$12$WSEHsn4jxmPQAEAHUAPfMOTwRi52jbaBfA0QOoZHvPgkr2CoxQ5sS', 0, -2, now(), now());
...
INSERT INTO account_auth_info (last_ip_address, current_auth, last_success_auth, last_incorrect_auth, incorrect_auth_count, account_id) VALUES (null, null, null, null, 0, -2);
...
INSERT INTO account (id, active, confirm, login, password, version, account_details_id, modification_date_time, creation_date_time) VALUES (-3, true, true, 'jstanczyk', '$2y$12$WSEHsn4jxmPQAEAHUAPfMOTwRi52jbaBfA0QOoZHvPgkr2CoxQ5sS', 0, -3, now(), now());
...
INSERT INTO account_auth_info (last_ip_address, current_auth, last_success_auth, last_incorrect_auth, incorrect_auth_count, account_id) VALUES (null, null, null, null, 0, -3);
...
INSERT INTO account (id, active, confirm, login, password, version, account_details_id, modification_date_time, creation_date_time) VALUES (-4, true, true, 'jzygmunt', '$2y$12$WSEHsn4jxmPQAEAHUAPfMOTwRi52jbaBfA0QOoZHvPgkr2CoxQ5sS', 0, -4, now(), now());
...
INSERT INTO account_auth_info (last_ip_address, current_auth, last_success_auth, last_incorrect_auth, incorrect_auth_count, account_id) VALUES (null, null, null, null, 0, -4);
...
INSERT INTO account (id, active, confirm, login, password, version, account_details_id, modification_date_time, creation_date_time) VALUES (-5, true, true, 'jnozderka', '$2y$12$WSEHsn4jxmPQAEAHUAPfMOTwRi52jbaBfA0QOoZHvPgkr2CoxQ5sS', 0, -5, now(), now());
...
INSERT INTO account_auth_info (last_ip_address, current_auth, last_success_auth, last_incorrect_auth, incorrect_auth_count, account_id) VALUES (null, null, null, null, 0, -5);
...
INSERT INTO account (id, active, confirm, login, password, version, account_details_id, modification_date_time, creation_date_time) VALUES (-6, true, true, 'szaryn', '$2y$12$WSEHsn4jxmPQAEAHUAPfMOTwRi52jbaBfA0QOoZHvPgkr2CoxQ5sS', 0, -6, now(), now());
...
INSERT INTO account_auth_info (last_ip_address, current_auth, last_success_auth, last_incorrect_auth, incorrect_auth_count, account_id) VALUES (null, null, null, null, 0, -6);
