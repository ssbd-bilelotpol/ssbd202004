...
export default {
    pl: {
        translation: {
            ...
            'error.flight.departed': 'Lot już się odbył',
            'error.flight.departureTimeChanged': 'Data jednego z lotów uległa zmianie',
            'error.flight.priceChanged': 'Wystąpiła zmiana ceny lotu',
